...
import os
from agents import Agent, Runner, OpenAIChatCompletionsModel, RunContextWrapper, SQLiteSession, function_tool, ModelSettings, enable_verbose_stdout_logging, RunConfig
...
print(f"\nResponse from 3rd run: {result3.final_output}\n")
